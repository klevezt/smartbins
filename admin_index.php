<?php
	...
	// Access: Admin
	// Purpose: Index Page for Administrator
...
<ol class=\"breadcrumb\">
            ...
            <li class=\"breadcrumb-item active\">Διαχειριστής</li>
</ol>
";
...
<div class=\"col-xl-4 col-sm mb-4\">
              <div class=\"card text-white bg-primary o-hidden h-100\">
                ...
                <a class=\"card-footer text-white clearfix small z-1\" href=\"admin_list_of_bins.php\">
...
if($_SESSION['role']==0) {
    echo "<div class=\"col-xl-4 col-sm mb-4\">
              <div class=\"card text-white bg-warning o-hidden h-100\">
                <div class=\"card-body\">
                  <div class=\"card-body-icon\">
                    <i class=\"fas fa-fw fa-user\"></i>
                  </div>
                  <div class=\"mr-5\">" . __('Ενεργοί Χρήστες:') . " " . $count1 . " </div>
                </div>
                <a class=\"card-footer text-white clearfix small z-1\" href=\"admin_list_of_emps.php\">
                  <span class=\"float-left\">Λεπτομέρειες</span>
                  <span class=\"float-right\">
                    <i class=\"fas fa-angle-right\"></i>
                  </span>
